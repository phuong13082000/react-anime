            ...
            <div className="product__sidebar__view">
                ...
                <div className="filter__gallery">
                    <div className="product__sidebar__view__item set-bg mix day years">
                        ...
                        <h5>
                            <a href="src/components/Homepage#">Boruto: Naruto next generations</a>
                        </h5>
                    </div>
                    <div className="product__sidebar__view__item set-bg mix month week">
                        ...
                        <h5>
                            <a href="src/components/Homepage#">The Seven Deadly Sins: Wrath of the Gods</a>
                        </h5>
                    </div>
                    <div className="product__sidebar__view__item set-bg mix week years">
                        ...
                        <h5>
                            <a href="src/components/Homepage#">
                    ...
                    <div className="product__sidebar__view__item set-bg mix day">
                        ...
                        <h5>
                            <a href="src/components/Homepage#">Fate stay night unlimited blade works</a>
                        </h5>
                    </div>
                </div>
            </div>
