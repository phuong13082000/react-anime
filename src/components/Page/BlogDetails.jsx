                        ...
                        <div className="col-lg-8">
                            <div className="blog__details__title">
                                ...
                                <div className="blog__details__social">
                                    <a href="#" className="facebook"><i className="fa fa-facebook-square"/> Facebook</a>
                                    <a href="#" className="pinterest"><i className="fa fa-pinterest"/> Pinterest</a>
                                    <a href="#" className="linkedin"><i className="fa fa-linkedin-square"/> Linkedin</a>
                                    <a href="#" className="twitter"><i className="fa fa-twitter-square"/> Twitter</a>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-12">
                            <div className="blog__details__pic">
                                <img src="http://localhost:3000/img/blog/details/blog-details-pic.jpg" alt=""/>
                            </div>
                        </div>
                        <div className="col-lg-8">
                            <div className="blog__details__content">
                                ...
                                <div className="blog__details__item__text">
                                    ...
                                    <img src="http://localhost:3000/img/blog/details/bd-item-1.jpg" alt=""/>
                                    <p>
                                ...
                                <div className="blog__details__item__text">
                                    ...
                                    <img src="http://localhost:3000/img/blog/details/bd-item-2.jpg" alt=""/>
                                    <p>
                                        In Japan the idea of a first-year speaking to a senior the way
                                        Kageyama did to Asahi is a lot more shocking than it would be in
                                        the West, but Tobio calling out teammates in genuinely rude
                                ...
                                <div className="blog__details__item__text">
                                    <h4>ID:Ianvaded:</h4>
                                    <img src="http://localhost:3000/img/blog/details/bd-item-3.jpg" alt=""/>
                                    <p>
                                        In Japan the idea of a first-year speaking to a senior the way
                                        Kageyama did to Asahi is a lot more shocking than it would be in
                                        the West, but Tobio calling out teammates in genuinely rude
                                    ...
                                    <div className="row">
                                        <div className="col-lg-6">
                                            <div className="blog__details__btns__item">
                                                <h5>
                                                    <a href="#"><span className="arrow_left"/> Building a Better LiA...</a>
                                                </h5>
                                            </div>
                                        </div>
                                        <div className="col-lg-6">
                                            <div className="blog__details__btns__item next__btn">
                                                <h5>
                                                    <a href="#">Mugen no Juunin: Immortal – 21{" "}<span className="arrow_right"/></a>
                                                </h5>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="blog__details__comment">
                                    ...
                                    <div className="blog__details__comment__item">
                                        <div className="blog__details__comment__item__pic">
                                            <img src="http://localhost:3000/img/blog/details/comment-1.png" alt=""/>
                                        </div>
                                    ...
                                    <div className="blog__details__comment__item blog__details__comment__item--reply">
                                        <div className="blog__details__comment__item__pic">
                                            <img src="http://localhost:3000/img/blog/details/comment-2.png" alt=""/>
                                        </div>
                                        <div className="blog__details__comment__item__text">
                                            <span>Sep 08, 2020</span>
                                    ...
                                    <div className="blog__details__comment__item">
                                        <div className="blog__details__comment__item__pic">
                                            <img src="http://localhost:3000/img/blog/details/comment-3.png" alt=""/>
                                        </div>
                                        <div className="blog__details__comment__item__text">
                                            <span>Sep 08, 2020</span>
